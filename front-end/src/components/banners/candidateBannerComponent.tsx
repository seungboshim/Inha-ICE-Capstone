import { candidateBannerDummy } from "./bannerDummy"
...
export default function CandidateBannerComponent({candidateId, bannerId, handleClick}:Props) {

    const targetBanner = candidateBannerDummy.results.find(result => {
